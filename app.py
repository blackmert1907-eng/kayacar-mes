...
with head:
    ...
    st.caption(f"v0.18 MOBILE PRO • Kullanıcı: {USER['username']} • Rol: {ROLE}")
with logout:
    st.write("")
...
# ---------------- ADMIN UI ----------------
    ...
    if NAV=="🏷️ Etiketleme / QR":
        ...
        st.caption("v0.18: mobil okunabilir etiket motoru. Uyarı metinleri taslaktır; ticari satıştan önce ürünün SDS/SEA/CLP sınıflandırması ve hedef ülke etiket mevzuatıyla doğrulanmalıdır.")
...
st.divider()
st.caption("KayaCar Kimyasal MES v0.18 MOBILE PRO — Anlık ara ürün/ön karışım motoru • Yağ Fazı/Bakım Fazı/Solvent Fazı/Boya Ön Çözeltisi/Parfüm konsantresi • WIP transferi • Stoktan hazır kullanım • Mobil üretim • Audit.")
