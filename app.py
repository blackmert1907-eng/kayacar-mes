...
def render_phase_engine(active,operator=False):
    ...
    # v0.16: Yağ Fazı kaynağı her durumda görünür.
...
with head:
    ...
    st.caption(f"v0.16 MOBILE PRO • Kullanıcı: {USER['username']} • Rol: {ROLE}")
with logout:
    st.write("")
...
# ---------------- ADMIN UI ----------------
    ...
    if NAV=="🏷️ Etiketleme / QR":
        ...
        st.caption("v0.16: mobil okunabilir etiket motoru. Uyarı metinleri taslaktır; ticari satıştan önce ürünün SDS/SEA/CLP sınıflandırması ve hedef ülke etiket mevzuatıyla doğrulanmalıdır.")
...
st.divider()
st.caption("KayaCar Kimyasal MES v0.16 MOBILE PRO — Yağ Fazı stok kartı ve eski parti kurtarma • Canlı kaynak seçimi • Ayrı onay PIN’i • Mobil üretim • Etiket PNG/PDF • Audit.")
